...
addressForNameMap.PC = defaultAddress.slice(0, 15) + 'aa';
addressForNameMap.Misc = defaultAddress.slice(0, 15) + 'bb';
...
var changeAddress = function(name) {
  ...
  layout.status.label = "Disconnecting...";
  draw();
...
var h = Bangle.appRect.h - widgetHeight;
var statusHeight = 24;
...
var layout = new Layout( {
  ...
  c: [
    {type: "h",
      c: [
        {type:"btn", font:"4x6:2", label:"PC\n" + addressForNameMap.PC.slice(12), cb: l=>changeAddress('PC'), width: w/2, height: (h-statusHeight)/2, id: "PC" },
        {type:"btn", font:"4x6:2", label:"Phone\n" + addressForNameMap.Phone.slice(12), cb: l=>changeAddress('Phone'), width: w/2, height: (h-statusHeight)/2, id: "Phone" }
      ]
    },
    {type: "h",
      c: [
        {type:"btn", font:"4x6:2", label:"Misc\n" + addressForNameMap.Misc.slice(12), cb: l=>changeAddress('Misc'), width: w/2, height: (h-statusHeight)/2, id: "Misc" },
        {
